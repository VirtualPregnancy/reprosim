...
SHO_PUBLIC void export_1d_elem_geometry_grpd(const char *EXELEMFILE, const char *name, const char *mesh_code);
SHO_PUBLIC void export_1d_elem_field_grouped(int ne_field, const char *EXELEMFILE, const char *group_name, const char *field_name, const char *mesh_code );
